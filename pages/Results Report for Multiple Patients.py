...
# CatBoost
###############################################################################################
dff = pd.read_csv("/Users/nuri/PycharmProjects/pythonProject/dsml_final_project/heart.csv")
...
if option == "Lung Cancer":
	...
	if uploaded_file == None:
		...
		image = Image.open(
			'/Users/nuri/PycharmProjects/pythonProject/vbo_project_disease_prediction_ml/feature_importance_lung.png')
		st.image(image, caption='Feature Importance of Lung Cancer')
		final_dataframe = final_dataframe.to_csv()
		st.write(""" You have 8 patients diseased as lung cancer.""")
		st.write(""" Total Medicare Cost per patient = 52.000 $ """)
		st.info(""" Total monetary value of a patient is 416.000 $ """)
	...
	if uploaded_file == None:
		...
		st.dataframe(final_dataframe)
		image = Image.open(
			'/Users/nuri/PycharmProjects/pythonProject/vbo_project_disease_prediction_ml/heart_attack_features_imp.png')
		st.image(image, caption='Feature Importance of Lung Cancer')
		final_dataframe = final_dataframe.to_csv()
		st.write("""You may download your results from here.""")
		st.download_button(
